...
/**
 * KlinikMasterSearch represents the model behind the search form of `app\models\KlinikMaster`.
 */
class KlinikMasterSearch extends KlinikMaster
{
    /**
     * {@inheritdoc}
     */
